...
const modulePresentation: Record<ModuleId, {
  ...
  'data-entry': {
    ...
    titleEn: 'Data Entry',
    descriptionAr: 'رفع بيانات العملاء، ثم رفع ملفات كل عميل لوحدها.',
    descriptionEn: 'Upload client data, then upload each client’s files separately.',
    featuresAr: ['عملاء', 'رفع', 'ملفات'],
    featuresEn: ['Clients', 'Upload', 'Files'],
