...
export const dataEntryImportCatalog: ImportFieldDef[] = [
  ...
  { key: 'NationalId', en: 'National ID', ar: 'الرقم القومي', aliases: ['id', 'national id', 'id number', 'nid', 'الرقم القومي'] },
  { key: 'MobileNumber', en: 'Mobile number', ar: 'رقم الموبايل', aliases: ['tell', 'tel', 'telephone', 'mobile', 'phone', 'phone number', 'رقم الموبايل', 'رقم الهاتف', 'تليفون'] },
  { key: 'Address', en: 'Address', ar: 'العنوان', aliases: ['all address', 'address', 'العنوان'] },
  { key: 'Feedback', en: 'Feedback', ar: 'فيدباك', aliases: ['feedback', 'فيدباك', 'تعليق'] },
  { key: 'Notes', en: 'Notes', ar: 'ملاحظات', aliases: ['data', 'notes', 'ملاحظات', 'ملاحظة', 'بيانات'] },
